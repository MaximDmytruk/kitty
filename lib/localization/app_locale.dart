mixin AppLocale {
  ...
  static const String toPDF = 'Export to PDF';
  ...
  static const Map<String, dynamic> UA = {
    ...
    frequentlyAskedQuestions: 'Популярні запитання',
    logout: 'Вийти',
    toPDF: 'Завантажити в PDF',
    manageCategories: 'Редагувати категорії',
